...
<body>
  <div class="forum-container">
    <div class="forum forum-left">
      ...
      <div class="forum-subjects d-flex flex-column">
        ...
        foreach ($faturalar as $fatura) {
          echo "<a href='fatura-icerigi.php?kid={$fatura['id']}'>{$fatura['kurumadi']} - {$fatura['kullaniciadi']}</a>";
        }
        ?>
      </div>
    </div>
    ...
    <header class="d-flex justify-content-between align-items-center">
      ...
      <div class="admin-faturalar d-flex flex-column">
        <?php
        foreach ($faturalar as $fatura) {
        ?>
          <div class="admin-faturalar-item d-flex align-items-center justify-content-between">
            <p><?php echo $fatura['kurumadi']. " - ". $fatura['kullaniciadi']; ?></p>
            <div class="actions d-flex align-items-center ">
              <a class="btn btn-primary" href="fonksiyon.php?sil=<?php echo $fatura['id']; ?>">Sil</a>
            </div>
          </div>
        <?php
        }
      ...
      <div class="admin-faturalar d-flex flex-column">
        ...
        foreach ($kullanicilar as $kullanici) {
          $yetki = $kullanici['yetki']==1?"Yönetici":"Standart Kullanıcı";
        ?>
          <div class="admin-faturalar-item d-flex align-items-center justify-content-between">
            <p><?php echo "Kullanıcı Adı: {$kullanici['kullaniciadi']} -  Ad Soyad: {$kullanici['ad']} {$kullanici['soyad']} &nbsp&nbsp&nbsp E-Posta : {$kullanici['eposta']} -  Yetki: {$yetki}"; ?></p>
            <div class="actions d-flex align-items-center ">
              <a class="btn btn-primary" href="fonksiyon.php?kullanicisil=<?php echo $kullanici['id']; ?>">Sil</a>
            </div>
          </div>
        <?php
        }
